        ...
        var update = setInterval(function () {
            ...
            if (type === getEnemyTeam() && _this.damage > 0) {
                ...
                if (_this.isCollideWithPlayer2(_bullet, team) && !_this.isCollide) {
                    ...
                    var criticalDamage = _this.damage * (1.5 + _this.critical[1] / 100);
                    ...
                    else if (((_l = _this.onhit) === null || _l === void 0 ? void 0 : _l.includes('sniper skill e2')) || ((_m = _this.onhit) === null || _m === void 0 ? void 0 : _m.includes('sniper skill shift'))) {
                    ...
                    else if ((_12 = _this.onhit) === null || _12 === void 0 ? void 0 : _12.includes('akali')) {
                        if ((_13 = _this.onhit) === null || _13 === void 0 ? void 0 : _13.includes('skill q')) {
                            skillHit.akali = true;
                            setTimeout(function () {
                                skillHit.akali = false;
                            }, 50);
                        }
                        else if ((_14 = _this.onhit) === null || _14 === void 0 ? void 0 : _14.includes('skill shift1')) {
                    ...
                    else if ((_15 = _this.onhit) === null || _15 === void 0 ? void 0 : _15.includes('kaisa')) {
                        if ((_16 = _this.onhit) === null || _16 === void 0 ? void 0 : _16.includes('aa')) {
                            players[team].marker.kaisa += 1;
                        }
                        else if ((_17 = _this.onhit) === null || _17 === void 0 ? void 0 : _17.includes('skill e')) {
                            players[team].marker.kaisa += 2;
                        }
                    }
                    else if ((_18 = _this.onhit) === null || _18 === void 0 ? void 0 : _18.includes('ahri')) {
                        if ((_19 = _this.onhit) === null || _19 === void 0 ? void 0 : _19.includes('shift')) {
                            players[team].status.cc.stun = enemySkillInfo.shift.duration;
                            charClass.cooldown.q += enemySkillInfo.shift.duration;
                            charClass.cooldown.e += enemySkillInfo.shift.duration;
                            charClass.cooldown.shift += enemySkillInfo.shift.duration;
                    ...
                    else if ((_20 = _this.onhit) === null || _20 === void 0 ? void 0 : _20.includes('talon skill')) {
                        if (players[team].marker.talon.cooldown === 0) {
                            players[team].marker.talon.stack += 1;
                        }
                        if ((_21 = _this.onhit) === null || _21 === void 0 ? void 0 : _21.includes('talon skill e')) {
                            skillHit.talonE = true;
                            setTimeout(function () {
                                skillHit.talonE = false;
                            }, 50);
                    ...
                    else if ((_22 = _this.onhit) === null || _22 === void 0 ? void 0 : _22.includes('yasuo skill q2')) {
                        players[team].status.cc.stun += 100;
                        charClass.cooldown.q += 100;
                        charClass.cooldown.e += 100;
                        charClass.cooldown.shift += 100;
                    ...
                    if (hasShadowflame && isCritical && !((_23 = _this.onhit) === null || _23 === void 0 ? void 0 : _23.includes('objProjectile'))) {
                    ...
                    if (((_24 = _this.onhit) === null || _24 === void 0 ? void 0 : _24.includes('skill')) && !((_25 = _this.onhit) === null || _25 === void 0 ? void 0 : _25.includes('objProjectile'))) {
                    ...
                    var isRange = ((_26 = _this.onhit) === null || _26 === void 0 ? void 0 : _26.includes('range')) ? 1 : 0;
                    socket.send(JSON.stringify({
                        body: {
                            msg: 'damageAlert',
                            info: [
                ...
                else if (_this.isCollideWithNexus(gameObjects[11].objSelector, _bullet) && !_this.isCollide && !((_27 = _this.onhit) === null || _27 === void 0 ? void 0 : _27.includes('objProjectile'))) {
                    if (objHp[1] <= 0)
                        return;
                ...
                if (_this.isCollideWithPlayer(_bullet, type) && !_this.isCollide) {
                    // 부메랑 회부 - 자기 화면
                    if ((_28 = _this.onhit) === null || _28 === void 0 ? void 0 : _28.includes('ahri skill q2')) {
                        _this.isArrive = false;
                    }
                    else if ((_29 = _this.onhit) === null || _29 === void 0 ? void 0 : _29.includes('talon skill e2')) {
                        _this.isArrive = false;
                    }
                    else if (((_30 = _this.onhit) === null || _30 === void 0 ? void 0 : _30.includes("talon skill wheel2")) && _this.targetEnemy[1] === getEnemyTeam()) {
                        _this.isArrive = false;
                    }
                }
                    ...
                    if (!_this.canPass)
                        _this.isArrive = false;
                    if (char[team] == 'ezreal' && ((_31 = _this.onhit) === null || _31 === void 0 ? void 0 : _31.includes('skill'))) {
                        _this.isCollide = true;
            ...
            if (_this._movedDistance >= _this.reach * 1.5 && _this.isArrive) {
                if (((_32 = _this.onhit) === null || _32 === void 0 ? void 0 : _32.includes("ahri skill q1")) && type === team) {
                ...
                if (((_33 = _this.onhit) === null || _33 === void 0 ? void 0 : _33.includes("sniper skill e1")) && type === team) {
                    projectiles[type].push(new ProjectileBuilder()
                ...
                if (((_34 = _this.onhit) === null || _34 === void 0 ? void 0 : _34.includes("talon skill e1")) || ((_35 = _this.onhit) === null || _35 === void 0 ? void 0 : _35.includes("talon skill wheel"))) {
                    _this.speed = 0;
                    _this.damage = 0;
                    if (!talonEBack) {
                        if ((_36 = _this.onhit) === null || _36 === void 0 ? void 0 : _36.includes("e1")) {
                            talonEBack = true;
                            setTimeout(function () {
                                _this.isArrive = false;
                                skillHit.talonE = false;
                        ...
                        else if ((_37 = _this.onhit) === null || _37 === void 0 ? void 0 : _37.includes('wheel')) {
                            talonEBack = true;
                            setTimeout(function () {
                                _this.isArrive = false;
                                if (team === type) {
                ...
                if (!((_38 = _this.onhit) === null || _38 === void 0 ? void 0 : _38.includes('talon skill e1')) && !((_39 = _this.onhit) === null || _39 === void 0 ? void 0 : _39.includes('talon skill wheel')))
                    _this.isArrive = false;
                // this.isArrive = false;
            }
            if (!_this.isArrive) {

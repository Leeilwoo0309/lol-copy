        ...
        var update = setInterval(function () {
            ...
            if (type === getEnemyTeam() && _this.damage > 0) {
                ...
                if (_this.isCollideWithPlayer2(_bullet, team) && !_this.isCollide) {
                    ...
                    if (hasShadowflame && isCritical && !((_15 = _this.onhit) === null || _15 === void 0 ? void 0 : _15.includes('objProjectile'))) {
                    ...
                    if (((_16 = _this.onhit) === null || _16 === void 0 ? void 0 : _16.includes('skill')) && !((_17 = _this.onhit) === null || _17 === void 0 ? void 0 : _17.includes('objProjectile'))) {
                    ...
                    var isRange = ((_18 = _this.onhit) === null || _18 === void 0 ? void 0 : _18.includes('range')) ? 1 : 0;
                    socket.send(JSON.stringify({
                        body: {
                            msg: 'damageAlert',
                            info: [
                ...
                else if (_this.isCollideWithNexus(gameObjects[11].objSelector, _bullet) && !_this.isCollide && !((_19 = _this.onhit) === null || _19 === void 0 ? void 0 : _19.includes('objProjectile'))) {
                    if (objHp[1] <= 0)
                        return;
                ...
                if (_this.isCollideWithPlayer(_bullet, type) && !_this.isCollide) {
                    // 부메랑 회부 - 자기 화면
                    if ((_20 = _this.onhit) === null || _20 === void 0 ? void 0 : _20.includes('ahri skill q2')) {
                        _this.isArrive = false;
                    }
                    else if ((_21 = _this.onhit) === null || _21 === void 0 ? void 0 : _21.includes('talon skill e2')) {
                        _this.isArrive = false;
                    }
                    else if (((_22 = _this.onhit) === null || _22 === void 0 ? void 0 : _22.includes("talon skill wheel2")) && _this.targetEnemy[1] === getEnemyTeam()) {
                        _this.isArrive = false;
                    }
                }
                    ...
                    if (!_this.canPass)
                        _this.isArrive = false;
                    if (char[team] == 'ezreal' && ((_23 = _this.onhit) === null || _23 === void 0 ? void 0 : _23.includes('skill'))) {
                        _this.isCollide = true;
            ...
            if (_this._movedDistance >= _this.reach * 1.5 && _this.isArrive) {
                if (((_24 = _this.onhit) === null || _24 === void 0 ? void 0 : _24.includes("ahri skill q1")) && type === team) {
                ...
                if (((_25 = _this.onhit) === null || _25 === void 0 ? void 0 : _25.includes("sniper skill e1")) && type === team) {
                    projectiles[type].push(new ProjectileBuilder()
                ...
                if (((_26 = _this.onhit) === null || _26 === void 0 ? void 0 : _26.includes("talon skill e1")) || ((_27 = _this.onhit) === null || _27 === void 0 ? void 0 : _27.includes("talon skill wheel"))) {
                    ...
                    _this.damage = 0;
                    if (!talonEBack) {
                        if ((_28 = _this.onhit) === null || _28 === void 0 ? void 0 : _28.includes("e1")) {
                            talonEBack = true;
                            setTimeout(function () {
                                _this.isArrive = false;
                                skillHit.talonE = false;
                        ...
                        else if ((_29 = _this.onhit) === null || _29 === void 0 ? void 0 : _29.includes('wheel')) {
                            talonEBack = true;
                            setTimeout(function () {
                                _this.isArrive = false;
                                if (team === type) {
                ...
                if (!((_30 = _this.onhit) === null || _30 === void 0 ? void 0 : _30.includes('talon skill e1')) && !((_31 = _this.onhit) === null || _31 === void 0 ? void 0 : _31.includes('talon skill wheel')))
                    _this.isArrive = false;
                // this.isArrive = false;
            }
            if (!_this.isArrive) {
